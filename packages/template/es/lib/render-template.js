    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                formatCodeFunc = formatCodeFunc !== null && formatCodeFunc !== void 0 ? formatCodeFunc : formatCodeServer;
                result = [];
            ...
            case 1:
                ...
                for (i = 0; i < codeList.length; i++) {
                    itm = codeList[i];
                    result.push(checkType(itm, 'Object') ? itm : {
                        title: "\u6A21\u7248".concat(i + 1),
                        content: itm,
                    });
                }
