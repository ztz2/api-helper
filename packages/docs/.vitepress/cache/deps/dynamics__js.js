...
var require_dynamics = __commonJS({
  "../../node_modules/.pnpm/dynamics.js@1.1.5/node_modules/dynamics.js/lib/dynamics.js"(exports, module) {
    (function() {
      ...
      Set = function() {
        ...
        Set2.prototype.contains = function(v) {
          return this.obj[v] === 1;
        };
        return Set2;
      }();
      ...
      InterpolableString = function() {
        function InterpolableString2(parts) {
          this.parts = parts;
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
        }
        InterpolableString2.prototype.interpolate = function(endInterpolable, t) {
          ...
          return new InterpolableString2(newParts);
        };
        InterpolableString2.prototype.format = function() {
          var parts;
        ...
        InterpolableString2.create = function(value) {
          ...
          return new InterpolableString2(parts);
        };
        return InterpolableString2;
      }();
      InterpolableObject = function() {
        function InterpolableObject2(obj) {
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
          this.obj = obj;
        }
        InterpolableObject2.prototype.interpolate = function(endInterpolable, t) {
          ...
          return new InterpolableObject2(newObj);
        };
        InterpolableObject2.prototype.format = function() {
          return this.obj;
        };
        InterpolableObject2.create = function(value) {
          var k, obj, v;
          if (value instanceof Object) {
            ...
            return new InterpolableObject2(obj);
          }
          return null;
        };
        return InterpolableObject2;
      }();
      InterpolableNumber = function() {
        function InterpolableNumber2(value) {
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
          this.value = parseFloat(value);
        }
        InterpolableNumber2.prototype.interpolate = function(endInterpolable, t) {
          var end, start;
          start = this.value;
          end = endInterpolable.value;
          return new InterpolableNumber2((end - start) * t + start);
        };
        InterpolableNumber2.prototype.format = function() {
          return roundf(this.value, 5);
        };
        InterpolableNumber2.create = function(value) {
          if (typeof value === "number") {
            return new InterpolableNumber2(value);
          }
          return null;
        };
        return InterpolableNumber2;
      }();
      InterpolableArray = function() {
        function InterpolableArray2(values) {
          this.values = values;
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
        }
        InterpolableArray2.prototype.interpolate = function(endInterpolable, t) {
          ...
          return new InterpolableArray2(newValues);
        };
        InterpolableArray2.prototype.format = function() {
        ...
        InterpolableArray2.createFromArray = function(arr) {
          var values;
          ...
          return new InterpolableArray2(values);
        };
        InterpolableArray2.create = function(value) {
          if (value instanceof Array) {
            return InterpolableArray2.createFromArray(value);
          }
          return null;
        };
        return InterpolableArray2;
      }();
      Color = function() {
        function Color2(rgb, format) {
        ...
        Color2.componentToHex = function(c) {
          var hex;
          hex = c.toString(16);
          if (hex.length === 1) {
            return "0" + hex;
        ...
        Color2.prototype.toHex = function() {
          return "#" + Color2.componentToHex(this.rgb.r) + Color2.componentToHex(this.rgb.g) + Color2.componentToHex(this.rgb.b);
        };
        Color2.prototype.toRgb = function() {
          return "rgb(" + this.rgb.r + ", " + this.rgb.g + ", " + this.rgb.b + ")";
        };
        Color2.prototype.toRgba = function() {
          return "rgba(" + this.rgb.r + ", " + this.rgb.g + ", " + this.rgb.b + ", " + this.rgb.a + ")";
        };
        return Color2;
      }();
      InterpolableColor = function() {
        function InterpolableColor2(color) {
          this.color = color;
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
        }
        InterpolableColor2.prototype.interpolate = function(endInterpolable, t) {
          ...
          return new InterpolableColor2(new Color(rgb, end.format));
        };
        InterpolableColor2.prototype.format = function() {
        ...
        InterpolableColor2.create = function(value) {
          var color;
          ...
          if (color != null) {
            return new InterpolableColor2(color);
          }
          return null;
        };
        return InterpolableColor2;
      }();
      DecomposedMatrix2D = function() {
        function DecomposedMatrix2D2(props) {
          this.props = props;
          this.applyRotateCenter = __bind(this.applyRotateCenter, this);
          this.format = __bind(this.format, this);
          this.interpolate = __bind(this.interpolate, this);
        }
        DecomposedMatrix2D2.prototype.interpolate = function(endMatrix, t) {
          ...
          return new DecomposedMatrix2D2(newProps);
        };
        DecomposedMatrix2D2.prototype.format = function() {
          return "translate(" + this.props.translate.join(",") + ") rotate(" + this.props.rotate.join(",") + ") skewX(" + this.props.skew + ") scale(" + this.props.scale.join(",") + ")";
        };
        DecomposedMatrix2D2.prototype.applyRotateCenter = function(rotateC) {
      ...
      Matrix2D = function() {
        ...
        Matrix2D2.prototype.decompose = function() {
          var kx, ky, kz, r0, r1;
        ...
        Matrix2D2.prototype.applyProperties = function(properties) {
      ...
      Vector = function() {
        ...
        Vector2.prototype.e = function(i) {
        ...
        Vector2.prototype.cross = function(vector) {
          ...
          A = this.els;
          return new Vector2([A[1] * B[2] - A[2] * B[1], A[2] * B[0] - A[0] * B[2], A[0] * B[1] - A[1] * B[0]]);
        };
        ...
        Vector2.prototype.normalize = function() {
          ...
          return new Vector2(newElements);
        };
        Vector2.prototype.combine = function(b, ascl, bscl) {
      ...
      DecomposedMatrix = function() {
        ...
        DecomposedMatrix2.prototype.format = function() {
          return this.toMatrix().toString();
        };
        DecomposedMatrix2.prototype.toMatrix = function() {
        ...
        return DecomposedMatrix2;
      }();
      Matrix = function() {
        function Matrix2(els) {
          this.els = els;
        ...
        Matrix2.prototype.e = function(i, j) {
          if (i < 1 || i > this.els.length || j < 1 || j > this.els[0].length) {
            return null;
          }
          return this.els[i - 1][j - 1];
        };
        Matrix2.prototype.dup = function() {
          return new Matrix2(this.els);
        };
        ...
        Matrix2.prototype.toRightTriangular = function() {
        ...
        Matrix2.prototype.augment = function(matrix) {
        ...
        Matrix2.prototype.inverse = function() {
          ...
          ni = this.els.length;
          ki = ni;
          M = this.augment(Matrix2.I(ni)).toRightTriangular();
          kp = M.els[0].length;
          inverse_elements = [];
          ni += 1;
          while (--ni) {
          ...
          return new Matrix2(inverse_elements);
        };
        Matrix2.I = function(n) {
          var els, i, j, k, nj;
          els = [];
          k = n;
          n += 1;
          ...
          return new Matrix2(els);
        };
        Matrix2.prototype.decompose = function() {
        ...
        Matrix2.matrixForTransform = cacheFn(function(transform) {
        ...
        Matrix2.fromTransform = function(transform) {
          ...
          return new Matrix2(matrixElements);
        };
        return Matrix2;
      }();
      ...
      runLoopTick = function(t) {
        ...
        animations = animations.filter(function(animation2) {
          return toRemoveAnimations.indexOf(animation2) === -1;
        });
...
export default require_dynamics();
//# sourceMappingURL=dynamics__js.js.map
