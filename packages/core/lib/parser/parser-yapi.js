...
var ParserYapi = /** @class */ (function () {
    ...
    ParserYapi.prototype.parserProject = function () {
        var _a;
        var title = (0, util_1.filterDesc)(this.projectInfo.name);
        ...
        this.apiList.forEach(function (apiMap) {
            ...
            (_f = apiContent === null || apiContent === void 0 ? void 0 : apiContent.req_headers) === null || _f === void 0 ? void 0 : _f.forEach(function (item) {
                ...
                switch (item.value) {
                    ...
                    // 其他请求头信息
                    default: {
                        headerSchema.params.push((0, helpers_1.createSchema)('string', {
                            keyName: item.value,
                            title: (_a = (0, util_1.filterDesc)(item.desc)) !== null && _a !== void 0 ? _a : '',
                            rules: {
            ...
            try {
                ...
                try {
                    for (var reqQuery_1 = __values(reqQuery), reqQuery_1_1 = reqQuery_1.next(); !reqQuery_1_1.done; reqQuery_1_1 = reqQuery_1.next()) {
                        ...
                        // 字段
                        var scm = null;
                        var parserKeyName2SchemaRes = new parser_key_name_2_schema_1.default(p.name, 'string').parse();
                        if (parserKeyName2SchemaRes) {
                            ...
                            scm = (0, helpers_1.createSchema)('string', {
                                id: _this.generateId(),
                                description: (0, util_1.filterDesc)(p.desc),
                                keyName: keyName,
                                rules: {
