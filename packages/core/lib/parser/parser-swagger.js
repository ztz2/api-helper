...
var ParserSwagger = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _b.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, (0, json_schema_ref_parser_1.dereference)(document_1)];
                    case 4:
                ...
                for (var i = 0; i < pathsEntries.length; i++) {
                    ...
                    for (var w = 0; w < methodMapEntries.length; w++) {
                        ...
                        try {
                            ...
                            (0, util_1.processRequestSchemaPipeline)(api, requestDataSchema, requestExtraDataSchemaWrap.value, this);
                            (0, util_1.processResponseSchemaPipeline)(api, this);
    ...
    ParserSwagger.prototype.parseCommonParam = function (_a) {
        ...
        var headerSchema = (0, helpers_1.createSchema)('object');
                ...
                switch (parameterIn) {
                    ...
                    case 'query': {
                        ...
                        if (keyName.includes('.') || keyName.includes('[')) {
                            var parserKeyName2SchemaRes = new parser_key_name_2_schema_1.default(keyName, type).parse();
                            // dot 对象
                            if (parserKeyName2SchemaRes) {
                                ...
                                keyName = (0, util_1.filterKeyName)(parserKeyName2SchemaWrapNode.keyName);
                            }
                        }
                        if (scm_1 == null) {
                            break;
                        ...
                        if (parserKeyName2SchemaWrapNode == null) {
                            scm_1.rules.required = parameterIn === 'path' ? true : (0, util_1.checkType)(parameter.required, 'Boolean') ? parameter.required : false;
                        }
                        else {
                            scm_1.rules.required = (0, util_1.checkType)(parameter.required, 'Boolean') ? parameter.required : false;
                        }
                        scm_1.description = (0, util_1.filterDesc)(parameter.description);
                        ...
                        // 存在相同节点，进行合并
                        if (previousSchema) {
                            (0, util_1.deepMergeSchema)(previousSchema, scm_1);
                        }
                        else {
                    ...
                    case 'body': {
                        if (((_h = parameter.schema) === null || _h === void 0 ? void 0 : _h.type) === 'object' || ((_j = parameter.schema) === null || _j === void 0 ? void 0 : _j.type) === 'array') {
                            ...
                            if (isRootBody) {
                                ...
                                requestDataSchema.params.push((0, helpers_1.createSchema)('object', {
                                    params: temp ? [temp] : [],
                                    id: this.generateId(),
