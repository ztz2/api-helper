 ...
 * @return {void}
 */
export function treeForEach(tree, cb, children, mode) {
    if (tree === void 0) { tree = []; }
...
export function treeFilterByIds(tree, ids) {
    ...
    if (tree === void 0) { tree = []; }
    if (ids === void 0) { ids = []; }
    var treeList = treeToList(cloneDeep(tree));
    var result = [];
 ...
 * @return {array}
 */
export function treeFindParentNodes(tree, node, options) {
    if (tree === void 0) { tree = []; }
    var _a = merge({
        rootID: null,
        id: 'id',
...
export function treeMap(tree, cb, children, updateChildrenKey) {
    if (tree === void 0) { tree = []; }
    if (children === void 0) { children = 'children'; }
