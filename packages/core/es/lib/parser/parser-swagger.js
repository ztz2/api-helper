                ...
                for (var i = 0; i < pathsEntries.length; i++) {
                    ...
                    var _loop_1 = function (w) {
                        ...
                        try {
                                ...
                                for (var j = 0; j < parameters.length; j++) {
                                    ...
                                    if (parameter.in === 'path' || parameter.in === 'query' || parameter.in === 'formData') {
                                        ...
                                        if (((_j = parameter.schema) === null || _j === void 0 ? void 0 : _j.type) === 'object' || ((_k = parameter.schema) === null || _k === void 0 ? void 0 : _k.type) === 'array') {
                                            ...
                                            var t = transformType(parameter.schema.type, (_m = parameter === null || parameter === void 0 ? void 0 : parameter.schema) === null || _m === void 0 ? void 0 : _m.format, 'string');
                                            var temp = createSchema(t, {
                                                id: this_1.generateId(),
                            ...
                            processRequestSchema(requestDataSchema, requestSchemaRecord, (_s = (_r = (_q = apiMap.requestBody) === null || _q === void 0 ? void 0 : _q.content) === null || _r === void 0 ? void 0 : _r['application/x-www-form-urlencoded']) === null || _s === void 0 ? void 0 : _s.schema, requestKeyNameMemo_1, {
                                autoGenerateId: this_1.autoGenerateId,
