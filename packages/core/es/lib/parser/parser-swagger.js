                ...
                for (var i = 0; i < pathsEntries.length; i++) {
                    ...
                    for (var w = 0; w < methodMapEntries.length; w++) {
                        ...
                        try {
                            ...
                            // 将该API添加到所依赖的模块中
                            var apiTags = ((_j = apiMap === null || apiMap === void 0 ? void 0 : apiMap.tags) === null || _j === void 0 ? void 0 : _j.length) > 0 ? apiMap.tags : [UNKNOWN_GROUP_NAME];
                            try {
            ...
            var _loop_1 = function (j) {
                ...
                switch (parameterIn) {
                    ...
                    case 'query': {
                        ...
                        var type = transformType(parameter.type, {
                ...
                switch (parameterIn) {
                    ...
                    case 'body': {
                        if (((_j = parameter.schema) === null || _j === void 0 ? void 0 : _j.type) === 'object' || ((_k = parameter.schema) === null || _k === void 0 ? void 0 : _k.type) === 'array') {
                            ...
                            var t = transformType(parameter.schema.type, {
